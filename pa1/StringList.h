...
void moveNext(List L);													// If cursor is defined and not at back, move cursor one
																								...
																								// do nothing
void prepend(List L, int key, char *data);			// Insert new element into L. If L is non-empty,
																								// insertion takes place before front element.
void append(List L, int key, char *data);				// Insert new element into L. If L is non-empty,
																								// insertion takes place after back element.
void insertBefore(List L, int key, char *data); // Insert new element before cursor.
																								// Pre: length()>0, index()>=0
void insertAfter(List L, int key, char *data);	// Insert new element before cursor.
																								// Pre: length()>0, index()>=0
